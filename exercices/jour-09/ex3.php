...
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . "jour-09" . DIRECTORY_SEPARATOR . "Class" . DIRECTORY_SEPARATOR . "Cart.php";
...
$cart->updateProduct($products[0]->getID(), 2); // 2 produits en plus
// $cart->updateProduct($products[0]->getID(), 2);  // 2produits en moins
$cart->addProduct($products[1], 1);
// $cart->removeProduct($products[0]->getID()); // remove Clavier
// $cart->clear();
echo $cart->getTotal();
echo $cart->getCount();
?>
